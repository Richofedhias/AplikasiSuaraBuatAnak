...
public class WalkthroughtActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mList.add(new ScreenItem("Judul Pertama","Desc 1",R.drawable.apple));
        mList.add(new ScreenItem("Judul Kedua","Desc 2",R.drawable.avocado));
        mList.add(new ScreenItem("Judul Ketiga","Desc 3",R.drawable.banana));
